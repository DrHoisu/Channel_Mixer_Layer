...
class PredRNN(Base_method):
    ...
    def _predict(self, batch_x, batch_y, **kwargs):
        ...
        total_channel = self.args.total_channel + self.args.img_channel if self.args.fusion_method == 'mix' else self.args.total_channel
        img_channel = self.args.img_channel
        img_height, img_width = self.args.in_shape

        # preprocess
        test_ims = batch_x.permute(0, 1, 3, 4, 2).contiguous()
        ...
        real_input_flag = torch.zeros(
            ...
            self.args.patch_size ** 2 * total_channel)).to(self.device)
    ...
    def train_one_epoch(self, runner, train_loader, epoch, num_updates, eta=None, **kwargs):
        ...
        for batch_x, batch_y in train_pbar:
            ...
            # preprocess
            ims = batch_x.permute(0, 1, 3, 4, 2).contiguous()
